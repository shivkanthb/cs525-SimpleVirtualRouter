...
void sr_handlepacket(struct sr_instance* sr,
    ...
    switch (ntohs(ethr_hdr->ether_type)) {
        case ETHERTYPE_IP:
            ...
            if (iface) {
                printf("Receiving Ip to ethernet if\n");
...
/*---------------------------------------------------------------------
 * Method: sr_handle_icmp_packet(struct sr_instance* sr, unsigned int len, char* interface, struct sr_icmphdr* icmphdr, uint8_t* packet, struct ip* ip_hdr, struct sr_ethernet_hdr* ethr_hdr);
 * Scope:  Local
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: sr_handle_arp_packet(struct sr_instance* sr, unsigned int len, char* interface, uint8_t* packet)
 * Scope:  Global
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: create_ether_hdr(uint8_t dest[ETHER_ADDR_LEN], uint8_t src[ETHER_ADDR_LEN], uint16_t type)
 * Scope:  Global
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: setICMPchecksum(struct sr_icmphdr* icmphdr, uint8_t * packet, int len)
 * Scope:  Global
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: send_arp_request(struct sr_instance * sr, uint32_t dst_ip, char* interface)
 * Scope:  Global
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: free_old_cache(struct sr_instance * sr)
 * Scope:  Global
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: sr_route_packet(struct sr_instance * sr, uint8_t * packet, int len, char* interface)
 * Scope:  Global
 *---------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------
 * Method: sr_cache_host(struct sr_instance * sr, struct ip* ip_hdr, char * interface)
 * Scope:  local
 *---------------------------------------------------------------------*/
